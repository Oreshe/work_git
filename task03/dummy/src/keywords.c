...
static struct resword {
  ...
  int token;
    ...
    // attribute commented out in modutils 2.4.2.  People are using 'attribute'
    // as a field name which breaks the genksyms parser.  It is not a gcc
    // keyword anyway. KAO. }, { "attribute", ATTRIBUTE_KEYW },
...
static int is_reserved_word(register const char* str,
