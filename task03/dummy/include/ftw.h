...
/* Call a function on every element in a directory tree.  FLAG allows
   ...
   marked with __THROW.  */
#ifndef __USE_FILE_OFFSET64
extern int nftw(const char* __dir,
...
extern int __REDIRECT(
    nftw,
    (const char* __dir, __nftw_func_t __func, int __descriptors, int __flag),
...
#ifdef __USE_LARGEFILE64
#ifndef __USE_TIME64_REDIRECTS
extern int nftw64(const char* __dir,
                  __nftw64_func_t __func,
                  int __descriptors,
                  int __flag) __nonnull((1, 2));
#else
#ifdef __REDIRECT
extern int __REDIRECT(
    nftw64,
    (const char* __dir, __nftw64_func_t __func, int __descriptors, int __flag),
    __nftw64_time64) __nonnull((1, 2));
#else
#define nftw64 __nftw64_time64
#endif
