...
extern int mq_setattr(mqd_t __mqdes, const struct mq_attr *__restrict __mqstat,
...
extern int mq_notify(mqd_t __mqdes,
		     const struct sigevent *__notification) __THROW;
...
extern int mq_timedsend(mqd_t __mqdes, const char *__msg_ptr, size_t __msg_len,
			...
			const struct timespec *__abs_timeout) __nonnull((2, 5));
#else
#ifdef __REDIRECT
extern int __REDIRECT(mq_timedreceive,
		      (mqd_t __mqdes, char *__restrict __msg_ptr,
		       size_t __msg_len, unsigned int *__restrict __msg_prio,
		       const struct timespec *__restrict __abs_timeout),
		      __mq_timedreceive_time64) __nonnull((2, 5));

extern int __REDIRECT(mq_timedsend,
		      (mqd_t __mqdes, const char *__msg_ptr, size_t __msg_len,
		       unsigned int __msg_prio,
